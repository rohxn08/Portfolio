...
const PORTFOLIO_DATA = {
    ...
    <ul style="list-style-type: none; padding: 0;">
        ...
        <li style="margin-bottom: 0.5rem;">🌱 <strong>EX Intern </strong> at <strong>ABB India</strong></li>
    ...
    experience: [
        {
            ...
            description: "<strong>OCR-based Invoice Extraction</strong> (Feb 2026 – Apr 2026)<br>• Built a robust OCR pipeline with PaddleOCR and OpenCV to extract structured text from bilingual invoices.<br>• Implemented ROI-based preprocessing, logo and barcode detection, and production-ready JSON formatting with confidence scores.<br>• Optimized speed and accuracy, handling both Chinese and English templates with automated null value filtering.<br>• Achieved an average processing time of ~2.8 seconds on CPU.<br>• Converted the solution into a standalone executable (.exe) and successfully deployed it for the Chinese ABB team.<br><br><strong>AI-based Defect Detection (MCCB)</strong> (Feb 2026 – Apr 2026)<br>• Developed a <strong>Memory Bank-based Anomaly Detection</strong> system (PatchCore) using <strong>WideResNet50-2</strong> to identify manufacturing defects with high precision.<br>• Engineered an end-to-end pipeline integrating <strong>Hikrobot camera capture, PaddleOCR extraction, ORB & NCC spatial alignment</strong>, and anomaly scoring.<br>• Optimized memory footprint and inference speed by implementing <strong>Coreset Subsampling</strong> and significantly reduced false positives using <strong>Variance Masking</strong>.<br>• Deployed a robust <strong>dual-executable architecture</strong> for real-time factory floor inspection and dynamic memory bank generation for new component variants."
        }
    ],
    education: [
        {
